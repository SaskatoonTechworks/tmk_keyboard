...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = KEYMAP_GRID( /* Jack */
      ...
      RSFT, LCTL, LALT, LGUI, FN2,  SPC,  SPC,  FN1,  LEFT, DOWN, UP,   RGHT),
    [1] = KEYMAP_GRID( /* Jack colemak */
      TAB,  Q,    W,    F,    P,    G,    J,    L,    U,    Y,    SCLN, BSPC,
      ESC,  A,    R,    S,    T,    D,    H,    N,    E,    I,    O,    QUOT,
      LSFT, Z,    X,    C,    V,    B,    K,    M,    COMM, DOT,  SLSH, ENT,
      FN3,  LCTL, LALT, LGUI, FN2,  SPC,  SPC,  FN1,  LEFT, DOWN, UP,   RGHT),
    [2] = KEYMAP_GRID( /* Jack RAISE */
